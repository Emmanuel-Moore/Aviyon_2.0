...
<div class="uHdWpr">
	<div class="uHdInr">
		...
		<img class="uHdImg2 pA" src="img/temp/usr4.png"/>
		<div class="uHdNme diB pA">
			<span>@VGS<span id="verified" ver1="Verified"></span>
			<span class="uHdTil">Project Page</span>
		</div>
	</div>
	<img class="uHdImg1" src="img/temp/tempBnr2.jpg"/>
</div>
<!------ user header end -->
...
<div class="uHdWpr2">
	<div class="uHdInr">
		<ul class="uHdLi1 diB">
			...
			<li id="modTog_4a" onclick="modTog_4()">Forum</li>
...
<div class="bodyWpr2">
	...
	<div class="diB">
		...
		<div class="uSpla fL">
			...
			<a href="user.php?u=">
				<div class="prjxUsr">
					...
					<a href="user2.php?u=Emmanuel.Moore" class="prjxUsr1a diB fL">Emmanuel Moore</a><span id="verified" ver1="Verified"></span>
				</div>
			</a>
		...
		<div class="uSplc fL">
			...
			<!-- modTog_2 -->
			<div class="modTog_4 dN">

				<!-- pstUsr_2b module -->
				<div id="pstUsr_2b" class="upstWprx upwr1 dN">
					<div class="upstHlrx">
						<textarea id="pst2ax" placeholder="Hello there, would you like to post something?" onfocus="prjxMt2c()"></textarea>
					</div>
					<div id="pst2bx" class="upstFtrx dN">
						<span id="" class="imgUplIcn1 cP" info1="photo upload"></span>
						<span id="" class="pstBtn1 cP fR">post</span>
					</div>
				</div>
				...
				<!-- forum post -->
				<div id="upfp_1" class="upstWpr">
					<! --- user forum post -->
					<div class="upstHdr">
						<a href="user.php?="><img src="img/temp/usr2.jpg" /></a>
						<div class="upstInf diB">
							<a href="user2.php?u=Emmanuel.Moore" class="upstNme fL">Emmanuel Moore</a>
							<span id="verified" ver1="Verified"></span>
							<div class="diB"><span id="favIcn" class="favIcn cP" info1="Favorite"></span> &#8226; 5</div>
							<div class="diB">
								<ul id="pstCmt_2" class="pstSet psFx2 pA dN">
									<li id="">update</li>
									<li id="" onclick="upTgle('ucmt_2')">hide</li>
							...
							<span class="tmeStmp dB">7 mins ago</span>
						</div>
					</div>
					<div class="upstBdy">Random placeholder information in place of text.</div>

					<! --- user forum post -->
					<div class="upstHdr">
						<a href="user.php?="><img src="img/temp/usr3.png" /></a>
						<div class="upstInf diB">
							<a href="user.php?=" class="upstNme fL">Aviyon</a>
							<span id="verified" ver1="Verified"></span>
							<div class="diB"><span id="favIcn" class="favIcn cP" info1="Favorite"></span> &#8226; 5</div>
							<div class="diB">
								<ul id="pstCmt_2" class="pstSet psFx2 pA dN">
					...
					<div class="upstFtrWpr">
						...
						<div class="upstIco">
							<div><span id="favIcn" class="favIcn cP" info1="Favorite"></span> &#8226; 5</div>
							<div><span id="cmtIcn" class="cmtIcn cP" info1="Reply" onclick="upTgle('ucfp_1')"></span> &#8226; 1</div>
							<div>
								<ul id="pfpSet_1" class="pstSet psFx1 pA dN">
									<li id="">update</li>
									<li id="" onclick="upTgle('upfp_1')">hide</li>
									<li id="">delete</li>
									<li id="">report</li>
								</ul>
								<span id="setIcn_!" class="setIcn cP" info1="Settings" onclick="upTgle('pfpSet_1')"></span>
							</div>
						</div>

						<div id="ucfp_1" class="dN">
							<!---- footer post logic -->
							<div class="fplWpr">
								<img src="img/temp/usr2.jpg"/>
								<textarea placeholder="Would you like to reply?"></textarea>
							</div>
			...
			<div class="uSpla diB fR">
				<!--- notes -->
				<div class="ntPrg">Last updated: <br> Expected launch date:</div>
				...
				<ul class="prjLst">
					...
					<a href="user2.php?u=Emmanuel.Moore"><li>Emmanuel Moore</li></a>
