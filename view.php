...
<div class="mnHdr pF">
	<div class="mnInr">
		...
		<div class="hdrxWpr fR" onclick="upTgle('lgsuxWpr')">
			<span id="hdrx1a">login</span>
			<img id="hdrx1b" src="css/img/hdrxImg.png">
		</div>
	</div>
</div>
<!------ include header end -->
...
<header id="hdr_1a" class="mnHdr2 mnHdr2Fx dN pF">
...
<div class="bodyWpr">
	<!--- login signup module start -->
	<div class="lgsuxHlr fR">
		<div id="lgsuxWpr" class="lgsuxWpr lgsuxFx1 lgsuxfx2 pF dN">
			<div class="lgsux1a">
				<input id="ux" type="text" placeholder="Username"/>
				<input id="e1" type="text" placeholder="email"/>
				<input id="p1" type="password" placeholder="Passwowd"/>
			</div>
			<div class="lgsux1b dN">
				<input id="ax" type="text" placeholder="age"/>
				<input id="gx" type="text" placeholder="sex"/>
				<input id="p2" type="password" placeholder="Re-type Passwowd"/>
			</div>
			<div class="lgsux1c dN">
				<input id="e2" type="text" placeholder="email"/>
			</div>
			<div class="lgsuxFtr">
				<a id="lgsux1a" onclick="lgsux1a()">login</a> / <a id="lgsux1b" onclick="lgsux1b()">signup</a> / <a id="lgsux1c" onclick="lgsux1c()">forgot password</a>
			</div>
		</div>
	</div>
	<!--- login signup module end -->
	...
	<div class="diB">
		...
		<div class="lglxWpr diB fR">
			<!--- lglxMd1 -->
			<div class="lglxMd1">
				<h3 class="prjhv1">Media Title</h3>
